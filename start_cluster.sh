...
sudo docker -H ${MANAGER0_IP}:2375 run -d --restart always -p 4000:4000 --name swarm_manager_00 swarm:${SWARM_VERSION} manage -H :4000 --replication --advertise ${MANAGER0_IP}:2375 consul://${CONSUL0_IP}:8500
